...
<body>
   <div a>
	...
	<center><br><h1>Üye Girişi</h1>

<form action='oturumac.php' method='POST'>
	<table cellpadding='5'>		
		<tr><td>Mail Adresi:</td><td><input type='text' name='kullaniciemail'></td></tr>
		<tr><td>Parola:</td><td><input type='password' name='kullanicisifre'></td></tr>
		<tr><td></td><td><center><input type='submit' value='Giris'></center></td></tr>
	</table>
 ...
 <div a>
	...
	<center><br><h1>Admin Girişi</h1>

<form action='oturumac.php' method='POST'>
	<table cellpadding='5'>		
		<tr><td>Mail Adresi:</td><td><input type='text' name='adminemail'></td></tr>
		<tr><td>Parola:</td><td><input type='password' name='adminsifre'></td></tr>
		<tr><td></td><td><center><input type='submit' value='admingiris'></center></td></tr>
	</table>
